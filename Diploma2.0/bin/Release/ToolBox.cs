...
namespace Appearance
{
    public partial class ToolBox
    {
        ...
        public static void DrawEye(object sender, PaintEventArgs e, int width, int height, Graphics graphics)
        {
            graphics.SmoothingMode = SmoothingMode.HighQuality;
            Pen p = new Pen(StyleWindows._mainBorderColor, 2.0F);
            graphics.DrawArc(p, 2, 1, width - 4, height - 4, 180, 360);
            int elipseWidth = height / 2;
            graphics.DrawEllipse(p, width / 2 - elipseWidth / 2, height / 2 - elipseWidth / 2 - 1, elipseWidth, elipseWidth);
        }
        ...
        //
        public static void CheckedShrollCheckBoxGraphics(bool positionCheck, Control control, object sender, PaintEventArgs e)
        {
            StyleWindows STYLEWINDOWS = new StyleWindows();
            ToolBox TOOLBOX = new ToolBox();
            ...
            if (positionCheck)
            {
                p = new Pen(StyleWindows._mainColor, paintSize);
            }
            else
            {
                p = new Pen(TOOLBOX._offColor, paintSize);
            }
        ...
        public static bool PointCondition(bool check, Control pointCondition, Timer timer)
        {
        ...
        public static void AppearanceOfSubItems(bool check, Control control, int heightMaxVolume, Timer timer)
        {
            ...
            {
                //MessageBox.Show(control.Height + "!=" + heightMaxVolume);
